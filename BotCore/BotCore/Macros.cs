...
namespace BotCoreNET
{
    public static class Macros
    {
        ...
        {
            return Uri.IsWellFormedUriString(str, UriKind.Absolute) && (str.EndsWith(".png") || str.EndsWith(".jpg") || str.EndsWith(".jpeg") || str.EndsWith(".gif") || str.EndsWith(".webp"));
        }
        ...
        public static bool TryFind<TSource>(this IEnumerable<TSource> enumerable, Func<TSource, bool> operation, out TSource result)
        {
        ...
        public static EmbedBuilder EmbedFromException(Exception e)
        {
            ...
            {
                Title = $"{e.GetType()} - {e.Message}".MaxLength(EmbedHelper.EMBEDTITLE_MAX),
                Description = ("```" + e.StackTrace).MaxLength(EmbedHelper.EMBEDDESCRIPTION_MAX - 3) + "```",
    ...
    {
        public UnpopulatedMethodException() : base("Method not overwritten!") { }
        public UnpopulatedMethodException(string error) : base(error) { }
    }
